...
const srcGambar1 = 'C:\\Users\\ADLI\\.gemini\\antigravity-ide\\brain\\3be8f4e4-ecb7-4ce4-adba-e67e72229f3a\\media__1786198565108.png';
const srcGambar2 = 'C:\\Users\\ADLI\\.gemini\\antigravity-ide\\brain\\3be8f4e4-ecb7-4ce4-adba-e67e72229f3a\\media__1786198620716.png';

console.log('Copying Gambar 1 (SMAN 19 Crest)...');
fs.copyFileSync(srcGambar1, 'public/logo-crest.png');
fs.copyFileSync(srcGambar1, 'public/logo.png');

console.log('Copying Gambar 2 (App & Browser Tab Icon)...');
fs.copyFileSync(srcGambar2, 'public/app-icon.png');

// Decoder & Encoder for RGBA PNG
...
console.log('Gambar 2 size:', img2Parsed.width, 'x', img2Parsed.height);
...
console.log('Successfully updated logo-192.png, logo-512.png, logo-maskable-512.png, and favicon.png from Gambar 2!');
