  ...
  return (
    ...
    >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto h-screen">
        ...
        {/* Top Banner/Header */}
        <header className="brand-gradient md:!bg-none md:!bg-transparent text-white md:text-[#1e1b4b] sticky top-0 z-[50] flex-shrink-0 shadow-xl shadow-brand-900/15 md:shadow-none wave-bg md:wave-bg-none md:relative md:border-b md:border-brand-100/50">
