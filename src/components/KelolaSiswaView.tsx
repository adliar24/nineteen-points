                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-4 px-6 min-w-[200px]">
                          <div className="font-extrabold text-sm text-brand-950 flex flex-wrap items-center gap-2 leading-snug">
                            <span className="break-words">{toSentenceCase(siswa.nama)}</span>
