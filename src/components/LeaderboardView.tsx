    ...
    <div className="space-y-5 pb-20 animate-fade-in font-sans">
      ...
      <AnimatePresence>
        {currentStudentRank && (
          ...
          >
            <div className="bg-gradient-to-r from-brand-900 via-brand-800 to-accent-600 text-white p-3.5 sm:p-4 rounded-3xl shadow-2xl border border-brand-500/40 flex items-center justify-between gap-3 sm:gap-4">
              <div className="flex items-center gap-2.5 sm:gap-3 min-w-0 flex-1">
                <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-2xl bg-amber-400 text-brand-950 flex items-center justify-center font-black text-xs sm:text-sm shrink-0 shadow-md">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[11px] font-bold text-amber-200/90 leading-none mt-0.5">
                    {currentStudentRank.student.score} pts
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-1.5 sm:gap-2 shrink-0">
                <button
                  ...
                  className="px-2.5 sm:px-3 py-1.5 sm:py-2 bg-amber-400 text-amber-950 hover:bg-amber-300 rounded-2xl text-xs font-black transition-all cursor-pointer shrink-0 flex items-center gap-1 shadow-sm active:scale-95"
                >
                  <span>Kartu</span>
                ...
                <button
                  ...
                  className="px-2.5 sm:px-3 py-1.5 sm:py-2 bg-white/20 hover:bg-white/30 text-white rounded-2xl text-xs font-bold transition-all cursor-pointer shrink-0 flex items-center gap-1 shadow-sm active:scale-95"
                >
                  <span>Scroll</span>
