            ...
            >
              ...
              <div className="flex gap-2">
                ...
                {userSession.role !== "guru" && (
                  <button
                    onClick={() => {
                      setPhotoUploadSiswaId(detailStudent.id);
                      setDetailStudent(null);
                      document.getElementById("single-photo-upload-input")?.click();
                    }}
                    className="flex-1 flex items-center justify-center gap-2 py-3 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200 rounded-2xl text-sm font-black transition-all cursor-pointer"
                  >
